...
@section('content')
    <!-- Start Hero Area -->
    <section class="hero-section height-470" style="background-image:url{{asset('frontend/images/about_us.png')}}" data-aos="fade-up">
        <div class="hero-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
        ...
        <div class="container">
            <div class="row">
                <div class="mx-auto col-md-10">
                    <ul class="mb-3 nav nav-pills registration-top-nav-pills justify-content-center" id="pills-tab" role="tablist">
                        <li class="mr-2 nav-item" role="presentation">
                          <button class="nav-link active" id="pills-opening-info-tab" data-bs-toggle="pill" data-bs-target="#pills-opening-info" type="button" role="tab" aria-controls="pills-opening-info" aria-selected="true">Opening Info</button>
                        </li>
                        <li class="mr-2 nav-item" role="presentation">
                          <button class="nav-link" id="pills-basic-info-tab" data-bs-toggle="pill" data-bs-target="#pills-basic-info" type="button" role="tab" aria-controls="pills-basic-info" aria-selected="false">Basic-Info</button>
                        </li>
                            ...
                            <div class="apply-wrapper">
                                ...
                                <form action="#" class="p-5 apply_form bg_dark_9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="user_madrasa_name" placeholder=" Madrasa Name">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="user_madrasa_type">Type of Madrasa*</label>
                                                <select name="user_madrasa_type_id" id="user_madrasa_type" class="form-control">
                                                    <option value="1">Alim Madrasa</option>
                                                    <option value="2">Dakhil Madrasa</option>
                                                    <option value="3">Kamil Madrasa</option>
                                                    <option value="4">Fazil Madrasa</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="user_thana">Thana*</label>
                                                <select name="user_thana_id" id="user_thana" class="form-control">
                                                    <option value="1">Select the Thana</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="user_username">Enter Username/Email</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="g-recaptcha" data-sitekey="6Lf_PqsqAAAAALKeJwEWWj7tUrvLviBoIRyInFzO" data-callback="enableSubmitBtn"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="user_signature" class="form-control" id="user_signature" cols="30" rows="5" placeholder="Your Signature"></textarea>
                                            </div>
                                        </div>
                                    </div> -->
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <img src="assets/images/default-logo.png" alt="" srcset="" class="img-thumbnail user-avata-img">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder=" Recognition Level">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Geographic location">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4" data-aos="fade-up">
                        <div class="p-4 text-white highlights-section hover_bg">
                            ...
                            <ul>
                                <li><i class="mr-1 fa-solid fa-location-dot"></i>57/8, Shah Jalal Plaza (3rd Floor), East Rajabazar, 
