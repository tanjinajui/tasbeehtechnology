<x-layouts.app>
    ...
    <div class="flex justify-between items-center my-5">
        <flux:heading size="lg">All Mission Vision</flux:heading>
        <a href="{{ route('mission_vision.create') }}"
        ...
        <table class="w-full text-left text-sm text-slate-700 dark:text-slate-300">
            <thead
                ...
                <tr>
                    ...
                    <th scope="col" class="p-4">Mission</th>
                    <th scope="col" class="p-4">Vision</th>
                    ...
                    <tr class="even:bg-slate-50 dark:even:bg-zinc-700">
                        ...
                        <td class="p-4">
                            <div class="flex gap-2">
                                ...
                                <form action="{{ route('mission_vision.destroy', $item->id) }}" method="post"
                                    class="inline-block">
                                    @csrf
                                    @method('DELETE')
