<x-layouts.app>
    ...
    <div class="flex justify-between items-center my-5">
        <flux:heading size="lg">All Founder Messages</flux:heading>
                    ...
                    <tr class="even:bg-slate-50 dark:even:bg-zinc-700">
                        ...
                        <td class="p-4">
                            <div class="flex gap-2">
                                <flux:button href="{{ route('founder.edit', $item->id) }}" variant="primary">Edit</flux:button>
                                <form action="{{ route('founder.destroy', $item->id) }}" method="post"
                                    class="inline-block">
                                    @csrf
                                    @method('DELETE')
